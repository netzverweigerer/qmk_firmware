...
KC_LCTL, KC_LALT, KC_LGUI, BOTTOM, LOWER, KC_SPC, KC_SPC, RAISE, TOP, KC_RGUI, KC_RALT, KC_ENT
),

[_BOTTOM] = LAYOUT_planck_grid(
RESET, KC_F1, KC_F2, KC_F3, KC_F4, KC_T, KC_Y, KC_7, KC_8, KC_9, KC_P, KC_DEL,
...
KC_GRV, LSFT(KC_LBRC), LSFT(KC_8), LSFT(KC_9), LSFT(KC_0), RALT(KC_Q), LSFT(KC_RBRC), KC_NUBS, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),

[_TOP] = LAYOUT_planck_grid(
_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_T, KC_Y, KC_7, KC_8, KC_9, KC_P, KC_BSPC,
KC_TAB, KC_F5, KC_F6, KC_F7, KC_F8, KC_G, KC_MS_LEFT, KC_MS_DOWN, KC_MS_UP, KC_MS_RIGHT, KC_RBRACKET, KC_QUOT,
KC_LSFT, KC_F9, KC_F10, KC_F11, KC_F12, KC_V, KC_B, KC_1, KC_2, KC_3, KC_SLSH, KC_MS_BTN2,
KC_LCTL, BACKLIT, KC_LALT, KC_LGUI, LOWER, KC_MS_BTN1, KC_MS_BTN1, KC_MS_BTN2, KC_MS_BTN3, KC_RSFT, KC_RALT, KC_ENT
),
